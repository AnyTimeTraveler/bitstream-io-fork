...
//!
//!     fn to_writer<W: BitWrite + ?Sized>(&self, w: &mut W) -> core::io::Result<()> {
...
//!     }
//!
//!     fn write<W: core::io::Write>(&self, w: &mut ByteWriter<W, LittleEndian>) -> core::io::Result<()> {
//!         use core::convert::TryInto;
//!
//!         fn write_entry<W: core::io::Write>(
